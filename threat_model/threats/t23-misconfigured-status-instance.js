(function () {
    var threat = {
        ...
        response: [
            { id: "R20", name: "Code Validation", type: "Reduce", desc: "Mandate that security configuration properties navigate automated vulnerability configuration scanning checks before hitting production environments." },
