(function () {
    var threat = {
        ...
        response: [
            { id: "R14", name: "Domain-Bound Verification Challenges", type: "Reduce", desc: "Embed unique, strict single-use cryptographic nonces combined with target audience domain pins inside every transaction request object." }
        ],
