(function () {
    var threat = {
        ...
        response: [
            { id: "R13", name: "Asymmetric Cryptographic Holder Binding", type: "Reduce", desc: "Require mandatory cryptographic verification proofs during individual presentations, rendering static transaction copies useless without holding the operational private keys." },
